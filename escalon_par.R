...
script.dir<-"C:/Users/Usuario/Google Drive/USACH/TESIS/programas/cluster_VE5mins_NARX_p1/cluster/Results/Univariado/NARX_grilla1"
...
run<-function(
  ...
  type.folder = "Resp_esc"
)
{
  #src.dir <- file.path(script.dir, src.folder)
  tgt.dir <- file.path(script.dir, results.folder,type.folder)
